    ...
    <section className="section-home1">
      ...
      <div className="slider-outer-home1">
        <div className="slider-viewport-home1">
          ...
          >
            {slides.map((slide) => (
              <div key={slide.id} className="slide-home1">
                <div className="slide-inner-home1">
                  <div className="content-home1">
                    <h4 className="welcome-home1">Welcome to Visiomatix Media</h4>
                    ...
                    <button className="button-home1">Get Your Free Call</button>
                  </div>
        ...
        <div className="dots-home1">
          {[0, 1, 2].map((dotIndex) => (
            <span
              ...
              onClick={() => {
                if (dotIndex === 0) setCurrentIndex(0);
                if (dotIndex === 1) setCurrentIndex(2);
                if (dotIndex === 2) setCurrentIndex(4);
              }}
            />
          ))}
        </div>
